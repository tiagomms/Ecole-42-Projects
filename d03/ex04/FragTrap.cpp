...
void FragTrap::donutHell(std::string const & target)
{
	std::cout << "FR4G-TP <" << this->_name << "> attacks <" << target << "> with donut Hell! Now you will have to eat donuts for the rest of your life!" << std::endl;
}

void FragTrap::pingPong(std::string const & target)
{
	std::cout << "FR4G-TP <" << this->_name << "> attacks <" << target << "> by making him his ping Pong ball! Now he is going! to be smashed" << std::endl;
}
...
void FragTrap::vaulthunter_dot_exe(std::string const & target)
{
	...
	function_Array[0] = &FragTrap::donutHell;
	function_Array[1] = &FragTrap::pingPong;
