...
public class cam03 : MonoBehaviour {
...
//	private Camera		mainCamera;
	...
	bool gameLost()
	{
		return (Claire.transform.position.y <= -1f || Thomas.transform.position.y <= -1f || John.transform.position.y <= -1f);
	}
